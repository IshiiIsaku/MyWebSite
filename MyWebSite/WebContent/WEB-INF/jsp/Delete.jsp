...
<h4><font face="筆記体系" color="red">注意事項</font></h4>
<h5><font face="筆記体系" color="white">退会すると全ての登録データが削除されます。</font></h5>
</div>
                   <div class="mx-auto" style="width: 200px;">

			   		<form action="Delete" method="POST">

                            <button class="btn btn-primary" style="width: 150px;" type="submit" name="delete">
								退会する
							</button>
                    </form>
...
<br><br>
                    ...
                    <form action="Item" method="get">
									...
									<button class="btn btn-primary"  style="width: 150px; type="submit" name="notdelete">退会しない</button>
					</form>
					</div>
