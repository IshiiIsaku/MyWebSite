...
<br>
	<br>
			...
			<h2 class="mx-auto" style="width: 300px;"><font face="筆記体系"color="white">新規登録</font></h2>
...
<br>
								...
								<div class="mx-auto" style="width: 300px;">
									<input value="" name="loginId" type="text" required placeholder="ログインID">
								</div>
...
<br>
								<div class="mx-auto" style="width: 300px;">
									<input name="password1" type="password" required placeholder="パスワード（確認用）">
								</div>
								<br>
