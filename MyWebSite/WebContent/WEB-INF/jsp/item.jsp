...
<a style="color:red"href ="Delete?id=${user.loginId}"><button type="submit" class="btn btn-danger">退会</button></a>
</div>
<div class="mx-auto"style="float:right;width: 15%;">
		  ...
		  <div class="form-row align-items-center">
		    <div class="col-auto my-1">
		      ...
		      <select class="custom-select mr-sm-2" id="inlineFormCustomSelect">
		        ...
		        <option value="1">エチオピア:GOTITIナチュラル　ハイロースト 630円(100g)</option>
		        <option value="2">タンザニア:キゴマ　フルシティ 490円(100g)</option>
		        <option value="3">ケニア:マサイ　フレンチ 600円(100g)</option>
		        <option value="4">ルワンダ:フギナチュラル　シティ 500円(100g)</option>
		        <option value="5">コンゴ:ブルボンスペシャル　フルシティ 500円(100g)</option>
		      </select>
		     </div>
		    </div>
		  <div class="row">
				<div class="input-field col s8 offset-s2">
					<input type="text" name="kosuu" required placeholder="個数">
				</div>
		  </div>
